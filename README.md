...
这是自己准备用365天深入理解Go语言之后送给[自己](https://github.com/0e0w)的礼物。本项目记录这365天内的学习收获。本人编程零基础，只略懂一些Python。因此本项目部分章节可能很基础，请见谅。本项目大量的参考借鉴甚至复制了其他类似项目。感谢这些项目，感谢每一位Gopher。项目还未完成，仍持续更新整理中。
