...
这是作者准备用365天深入理解Go语言之后送给[自己](https://github.com/0e0w)的礼物。本项目用于记录这365天内的学习收获。本人编程几乎零基础，只略懂一些Python、PHP、Java等。因此本项目大部分章节都会很基础，请见谅。本项目大量的参考借鉴甚至复制了其他类似的项目。感谢这些项目，致敬每一位Gopher。项目未完成，持续更新整理中。
